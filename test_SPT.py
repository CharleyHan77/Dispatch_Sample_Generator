...
if __name__ == "__main__":
    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            ...
            # 将文件名作为字符串传入脚本运行
            #file_path = "data/Hurink/Text/rdata\orb10.fjs"
            makespan, time = start(file_path)
            file_display = f"/Text/"
            #file_display = file
    ...
    output_file = 'result/temp_xls/Brandimarte_MS_SPT.xlsx'
